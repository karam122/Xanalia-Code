        ...
        const fetchCollectionDetail = async () => {
            try {
                ...
                const collectionInfo =
                    await collectionServices.getCollectionInfo(query)
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    {collectionInfo.isOfficial === 1 && (
                                        <span
                                            className={`${
                                                collectionInfo.isOfficial ===
                                                    1 &&
                                                style[
                                                    'collection-off-logo-name-inner'
                                                ]
                                            }`}
                                        ></span>
                                    )}
                                ...
                                {collectionInfo.isOfficial === 1 &&
                                    collectionInfo.name.length > 25 && (
                                        <span
                                            className={`${
                                                collectionInfo.isOfficial ===
                                                    1 &&
                                                style[
                                                    'collection-off-logo-name'
                                                ]
                                            }`}
                                        ></span>
                                    )}
